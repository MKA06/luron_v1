...
SYSTEM_MESSAGE = """You are a helpful assistant. Speak naturally, in a friendly and professional manner. Give short and clear answers."""

# English voice from ElevenLabs
ELEVENLABS_VOICE_ID = "RXtWW6etvimS8QJ5nhVk"  # Antoni - works well for English
...
async def index_page():
    return {"message": "English Voice Pipeline with Deepgram (Improved) is running!"}
...
async def handle_media_stream(websocket: WebSocket):
    ...
    # Connect to Deepgram STT with English settings
    ...
    try:
        async with websockets.connect(
            ...
            print("Connected to Deepgram (English - Nova-3)")
            ...
            async def process_tts():
                ...
                # Connect to ElevenLabs WebSocket for English TTS
